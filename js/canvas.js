...
/*Над полученной анимацией можно экспериментировать, меняя размеры, плотность пузырьков, цвета. Вот так, например, это выглядит, если уменьшить плотность пузырьков до 50 (константа BUBBLE_DENSITY), а их размер сделать от 3 до 9 (свойство size класса Bubble):*/